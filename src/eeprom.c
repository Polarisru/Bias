...
const eeVal_t EEPROM_Values[] =
{
  ...
  {0x10, sizeof(int16_t),  (void*)&EE_DrainCurrent[0], {.u16 = 250}},
  {0x12, sizeof(uint16_t), (void*)&EE_DrainCurrent[1], {.u16 = 250}},
  {0x14, sizeof(uint16_t), (void*)&EE_DrainCurrent[2], {.u16 = 250}},
  {0x16, sizeof(uint16_t), (void*)&EE_DrainCurrent[3], {.u16 = 250}},
