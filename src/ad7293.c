...
bool AD7293_Configuration(void)
{
  ...
  /**< Set GIPOs polarity: ALERT0, ALERT1 active-low */
	AD7293_WriteWord(
		REGISTER_PAGE_CONFIGURATION,
		REGISTER_CONFIGURATION_DIGITAL_FUNCTION_POLARITY,
		REGISTER_CONFIGURATION_DIGITAL_OUTPUT_GPIO4 |
		REGISTER_CONFIGURATION_DIGITAL_OUTPUT_GPIO3
  );
  ...
  for (i = 0; i < AD7293_TEMPERATURE_LAST; i++)
    AD7293_WriteWord(
      ...
      REGISTER_LOW_LIMIT_0_TSENSEINT + i,
  ...
  #ifdef DEF_NEW
  /**< Set routing for ALERT0 pin */
  /**< ALERT0: Temperature */
	AD7293_WriteWord(
		REGISTER_ALERT0_PAGE,
		REGISTER_ALERT0_PIN_TSENSX,
    REGISTER_ALERT_PIN_TSENSX_HIGH_INT | REGISTER_ALERT_PIN_TSENSX_LOW_INT |
    REGISTER_ALERT_PIN_TSENSX_HIGH_D0 | REGISTER_ALERT_PIN_TSENSX_LOW_D0 |
    REGISTER_ALERT_PIN_TSENSX_HIGH_D1 | REGISTER_ALERT_PIN_TSENSX_LOW_D1
  );
  /**< ALERT0: Current */
	AD7293_WriteWord(
		REGISTER_ALERT0_PAGE,
		REGISTER_ALERT0_PIN_ISENSX,
    REGISTER_ALERT_PIN_ISENSX_HIGH_3 | REGISTER_ALERT_PIN_ISENSX_HIGH_2 |
    REGISTER_ALERT_PIN_ISENSX_HIGH_1 | REGISTER_ALERT_PIN_ISENSX_HIGH_0 |
